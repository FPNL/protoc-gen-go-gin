...
const (
	...
	codecPackage         = protogen.GoImportPath("github.com/FPNL/gin-codec")
...
// generateFile generates a _http.pb.go file containing kratos and codec errors definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool,
	omitemptyPrefix string) *protogen.GeneratedFile {
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool,
	...
	g.P("var _ = new(", codecPackage.Ident("Codec"), ")")
	g.P("var _ = ", ginPackage.Ident("EnvGinMode"))
...
func genService(_ *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service,
	omitempty bool, omitemptyPrefix string) {
...
func buildHTTPRule(g *protogen.GeneratedFile, service *protogen.Service, m *protogen.Method, rule *annotations.HttpRule,
	omitemptyPrefix string) *methodDesc {
	var (
		path         string
		method       string
		body         string
